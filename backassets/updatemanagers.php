...
elseif($_SESSION["allow"]!="boss"){
    ...
    if (isset($_POST['Address'])) {
        ...
        if (empty($errors)) {
            UpdateManager($id,$Address,$Phone,$pasword);
...
<html>
    ...
    <body>
        <div class="Form">
            ...
            <?php endforeach;?>
            <?php endif; ?>
            <form action="updatemanagers.php" method="post" class="Form1">
                ...
                <br>
                <input type="text" name="Address" placeholder="Manager Address" required class="input" value="<?= $res["address"] ?>">
                <br>
                <label for="Phone" class="Lable"><i class="bi bi-telephone-plus" ></i> Phone Number</label><i class="i"> *</i>
                <br>
                <input type="text" name="Phone" placeholder="Manager Phone Number" required class="input" value="<?= $res["phone"] ?>">
                <br>
                <label for="password" class="Lable"><i class="bi bi-123"></i> password</label><i class="i"> *</i>
                <br>
                <input type="password" name="password" placeholder="Manager password" required class="input" value="<?= $res["password"] ?>">
                <br>
