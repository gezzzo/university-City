...
elseif($_SESSION["allow"]!="boss" && $_SESSION["allow"]!="manager" ){
    ...
    if ($_SESSION["allow"]=="boss") {
        $allstudents =allGraduatingstudent();
    }
    elseif($_SESSION["allow"]=="manager"){
        $allstudents =allGraduatingstudentsbyId($_SESSION["user"]["build_id"]);
    }
...
<html>
    ...
    <body>
        ...
        <div>
            <table class="table2">
                <h1 style="text-align: center;">Graduation Student informations</h1>
                <tr class="tr2">
                ...
                <th><i class="bi bi-faculty"></i>ondate</th>
                <th><i class="bi bi-level"></i>outdate</th>
            </tr>
            ...
            <tr>
                ...
                <th><?= $students["ondate"] ?></th>
                <th><?= $students["outdate"] ?></th>
